...
<main>
    <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <a class="navbar-brand" href="/">Pianobrary</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarText">
                      ...
                      <li class="nav-item"><a class="nav-link" href="{{ route('pianos') }}">Liste</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('create') }}">rajouter un piano</a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center text-white">
					<p>Panobrary.</p>
					<p class="h6">&copy All right Reversed.<a class="text-green ml-2" href="https://www.sunlimetech.com" target="_blank">L.saouci</a></p>
				</div>
				<hr>
			</div>	
		</div>
